/*
 * #%L
 * Unified Communication Service Support
 * %%
 ...
 */
public class AlertingBroadcaster extends AbstractBroadcaster<UCSAlertingIntf> implements UCSAlertingIntf {
    
    
    private static final Log log = LogFactory.getLog(AlertingBroadcaster.class);
