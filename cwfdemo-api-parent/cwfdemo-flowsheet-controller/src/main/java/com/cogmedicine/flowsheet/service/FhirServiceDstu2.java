...
public class FhirServiceDstu2 {
    ...
    private static String dstu2Server;
    ...
    static {
        ...
        dstu2Server = properties.getProperty("fhir.service.dstu2.root.url");

        fhirContextDstu2 = FhirContext.forDstu2();
        clientDstu2 = fhirContextDstu2.newRestfulGenericClient(dstu2Server);
    }
    ...
    public static <T> void removeResource(Class<T> clazz, String id) {
        clientDstu2.delete().resourceById(clazz.getSimpleName(), id).execute();
    }
