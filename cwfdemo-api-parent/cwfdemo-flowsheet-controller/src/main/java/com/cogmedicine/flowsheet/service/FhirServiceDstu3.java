...
import com.cogmedicine.flowsheet.bean.IOGridModel;
import com.cogmedicine.flowsheet.bean.IOVitalsFormat;
...
public class FhirServiceDstu3 {
    ...
    public final static SimpleDateFormat queryDateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss");
    ...
    public static Map getIOData(String patientId, String startDateString, String endDateString){
        Date startDate;
        Date endDate;
        try{
        ...
        Bundle bundle = clientDstu3.search().forResource(MedicationAdministration.class)
        ...
        IOGridModel grid = new IOGridModel(bundle, startDate, endDate);
        IOVitalsFormat vitalsFormat = new IOVitalsFormat(grid);

        return vitalsFormat.getFlowsheetGridModel();
    }
}