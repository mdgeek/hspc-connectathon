...
public class DevicesMainController extends PluginController {
                    ...
                    epsService.subscribe(EPS_OBSERVATIONS_TOPIC, new EPSService.IEventCallback() {
                        ...
                        public void onEvent(Message event) {
                            ...
                            if (resource instanceof Observation) {
                                ...
                                if (selectedDeviceId.endsWith(observationDeviceId) || observationDeviceId.endsWith(selectedDeviceId)) {
    ...
    public void onLoad(PluginContainer container) {
        ...
        container.registerProperties(this, "cfgPlotThreshold", "cfgEPSEndpoint", "cfgFHIREndpoint", "cfgFHIRUsername", "cfgFHIRPassword");
    ...
    public void onSelect$cboComponent(SelectEvent<Combobox, DeviceComponent> e) {
        chart.setTitle(((DeviceComponent) ((Combobox) e.getTarget()).getSelectedItem().getValue()).getType().getCodingFirstRep().getDisplay());
    }
    ...
    /**
     * Overrides the default services (fhir/eps/etc.) if the required
    ...
    private void configureServices() {
        ...
        if (!StringUtils.isEmpty(cfgFHIREndpoint)) {
            ...
            if (!StringUtils.isEmpty(cfgFHIRUsername) && !StringUtils.isEmpty(cfgFHIRPassword)) {
                org.hspconsortium.cwf.fhir.client.FhirContext.registerAuthInterceptor(
                    "basic", new BasicAuthInterceptor("basic", new BasicAuthConfigurator(){
                        @Override
